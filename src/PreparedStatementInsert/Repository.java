...
public class Repository {
    void insertNewChild(String name, String address, int country, int responsibleElf) throws IOException {
        ...
        try (Connection connection = DriverManager.getConnection(properties.getProperty("connectionString"), properties.getProperty("name"),
             ...
             PreparedStatement preparedStatement = connection.prepareStatement(
                     "insert into Barn (namn, adress, landId, ansvarigFörBarn) values (?,?,?,?)");
            ...
            preparedStatement.setInt(4, responsibleElf);
